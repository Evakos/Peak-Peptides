import { ArrowRight, Check, Zap, Target, Users, Heart, Clock, Shield, TrendingDown, X, Award, Activity, Dumbbell } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="sticky top-0 w-full bg-black/90 backdrop-blur-sm z-50 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            <a href="#features" className="text-gray-400 hover:text-white transition-colors text-sm uppercase tracking-wide">Protocol</a>
            <a href="#pricing" className="text-gray-400 hover:text-white transition-colors text-sm uppercase tracking-wide">Access</a>
            <a href="#testimonials" className="text-gray-400 hover:text-white transition-colors text-sm uppercase tracking-wide">Results</a>
            <button className="bg-red-600 text-white px-6 py-2.5 hover:bg-red-700 transition-colors font-semibold text-sm uppercase tracking-wide">
              Apply
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button className="bg-red-600 text-white px-10 py-4 hover:bg-red-700 transition-all flex items-center justify-center gap-2 font-bold uppercase tracking-wide text-sm border border-red-500 shadow-lg shadow-red-600/20">
                Request Access
                <ArrowRight className="w-5 h-5" />
              </button>
              <button className="bg-transparent text-white px-10 py-4 hover:bg-white/5 transition-all flex items-center justify-center gap-2 font-semibold uppercase tracking-wide text-sm border border-gray-700">
                View Protocol
              </button>
            </div>
      ...
      {/* Pain Points Section */}
      <section className="py-20 px-6 bg-gradient-to-b from-black to-gray-900 border-y border-gray-800">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-black text-center mb-4 tracking-tight">Natural Limits.<br/>Broken.</h2>
          <p className="text-center text-gray-500 mb-12 text-sm uppercase tracking-widest">What's holding you back?</p>
          <div className="grid md:grid-cols-2 gap-4 mt-8">
            <div className="bg-gray-900/50 border border-gray-800 p-4">
              <p className="text-gray-400">Training plateaus despite perfect programming</p>
            </div>
            <div className="bg-gray-900/50 border border-gray-800 p-4">
              <p className="text-gray-400">Recovery time killing your training frequency</p>
            </div>
            <div className="bg-gray-900/50 border border-gray-800 p-4">
              <p className="text-gray-400">Stubborn fat despite single-digit body fat goals</p>
            </div>
            <div className="bg-gray-900/50 border border-gray-800 p-4">
              <p className="text-gray-400">Age stealing your performance edge</p>
            </div>
            <div className="bg-gray-900/50 border border-gray-800 p-4">
              <p className="text-gray-400">Joint pain limiting your intensity</p>
            </div>
            <div className="bg-gray-900/50 border border-gray-800 p-4">
              <p className="text-gray-400">Natural limits holding you back</p>
            </div>
          </div>
          <div className="text-center mt-12 pt-8 border-t border-gray-800">
            <p className="text-gray-400 mb-2">Your genetics aren't the problem.</p>
            <p className="text-xl font-bold text-white">Your <span className="text-red-500">protocol</span> is.</p>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-20 px-6 bg-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-black mb-4 tracking-tight">The <span className="text-red-500">Protocol</span></h2>
      ...
      {/* Scarcity Banner */}
      <section className="py-6 px-6 bg-black border-y border-red-600/20">
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-20 px-6 bg-black border-y border-gray-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-black mb-4 tracking-tight">The <span className="text-red-500">Process</span></h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-900 border border-gray-800 p-8">
              ...
              <div className="relative overflow-hidden border border-gray-800 mb-6">
                <img
                  src="https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmaXRuZXNzJTIwbXVzY2xlJTIwYnVpbGRpbmclMjBhdGhsZXRpYyUyMHBlcmZvcm1hbmNlfGVufDF8fHx8MTc4MDI5MzIwNXww&ixlib=rb-4.1.0&q=80&w=1080"
            ...
            <div className="bg-gray-900 border border-gray-800 p-8">
              ...
              <div className="relative overflow-hidden border border-gray-800 mb-6">
                <img
                  src="https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwzfHxmaXRuZXNzJTIwbXVzY2xlJTIwYnVpbGRpbmclMjBhdGhsZXRpYyUyMHBlcmZvcm1hbmNlfGVufDF8fHx8MTc4MDI5MzIwNXww&ixlib=rb-4.1.0&q=80&w=1080"
                  alt="Weight training"
                  className="w-full h-48 object-cover grayscale opacity-70"
                />
              </div>
            ...
            <div className="bg-gray-900 border border-gray-800 p-8">
              ...
              <div className="relative overflow-hidden border border-gray-800 mb-6">
                <img
                  src="https://images.unsplash.com/photo-1549476464-37392f717541?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHw0fHxmaXRuZXNzJTIwbXVzY2xlJTIwYnVpbGRpbmclMjBhdGhsZXRpYyUyMHBlcmZvcm1hbmNlfGVufDF8fHx8MTc4MDI5MzIwNXww&ixlib=rb-4.1.0&q=80&w=1080"
      ...
      <section id="pricing" className="py-20 px-6 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-5xl font-black mb-4 tracking-tight">Access <span className="text-red-500">Tiers</span></h2>
            <p className="text-gray-500 text-sm uppercase tracking-widest">Select Your Protocol Level</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <div className="bg-gray-900 p-8 border border-gray-800">
              ...
              <button className="w-full bg-gray-800 text-white py-4 hover:bg-gray-700 transition-colors mb-8 font-bold uppercase tracking-wide text-sm border border-gray-700">
                Request Access
              </button>
            ...
            {/* Elite Plan - FEATURED */}
            <div className="bg-black p-8 border-2 border-red-600 relative transform md:scale-105 shadow-2xl shadow-red-600/20">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-red-600 text-white px-6 py-1 text-xs font-bold uppercase tracking-widest">
                Recommended
              </div>
              ...
              <button className="w-full bg-red-600 text-white py-4 hover:bg-red-700 transition-colors mb-8 font-bold uppercase tracking-wide text-sm border border-red-500 shadow-lg shadow-red-600/30">
                Secure Access
              </button>
          ...
          <div className="text-center mt-12 pt-12 border-t border-gray-800">
            <div className="inline-flex items-center gap-3">
              ...
              <span className="text-gray-500 text-sm uppercase tracking-widest">60-Day Protocol Guarantee</span>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Mid-page CTA */}
      <section className="py-20 px-6 bg-gradient-to-b from-gray-900 via-black to-gray-900 border-y border-red-600/20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <button className="bg-red-600 text-white px-12 py-4 hover:bg-red-700 transition-all inline-flex items-center gap-2 font-bold uppercase tracking-wide text-sm border border-red-500 shadow-lg shadow-red-600/20">
            Request Access
            <ArrowRight className="w-5 h-5" />
          </button>
      ...
      <section className="py-20 px-6 bg-gray-900 border-y border-gray-800">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-5xl font-black text-center mb-4 tracking-tight">Why <span className="text-red-500">Peak Peptides</span></h2>
          ...
          <div className="text-center mt-12">
            <button className="bg-red-600 text-white px-10 py-4 hover:bg-red-700 transition-colors inline-flex items-center gap-2 font-bold uppercase tracking-wide text-sm border border-red-500 shadow-lg shadow-red-600/20">
              Request Access
              <ArrowRight className="w-5 h-5" />
            </button>
          </div>
      ...
      {/* Testimonials */}
      <section id="testimonials" className="py-20 px-6 bg-black border-y border-gray-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-black mb-4 tracking-tight"><span className="text-red-500">Proven</span> Results</h2>
            <p className="text-gray-500 text-sm uppercase tracking-widest">38,492+ Elite Transformations</p>
          </div>

          {/* Featured Transformation */}
          <div className="bg-gray-900 border border-gray-800 p-8 md:p-12 mb-12 max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h3 className="text-2xl font-black mb-4 text-white">"Gained 23 Pounds of Pure Muscle in 90 Days"</h3>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-14 h-14 bg-red-600/10 border border-red-600/30 flex items-center justify-center font-black text-sm text-red-500">
                    JB
                  </div>
                  <div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-900 border border-gray-800 p-8">
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-red-600/10 border border-red-600/30 flex items-center justify-center font-black text-xs text-red-500">
                  MC
                </div>
                <div>
      ...
      <section className="py-20 px-6 bg-gray-900 border-y border-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          <div className="w-24 h-24 bg-red-600/10 border border-red-600/30 flex items-center justify-center mx-auto mb-6">
            <Shield className="w-12 h-12 text-red-500" />
          </div>
          <h2 className="text-5xl font-black mb-6 tracking-tight"><span className="text-red-500">Zero</span> Risk Guarantee</h2>
      ...
      <section className="py-20 px-6 bg-black border-y border-gray-800">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-5xl font-black text-center mb-4 tracking-tight">Common <span className="text-red-500">Questions</span></h2>
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-black via-gray-900 to-black">
        <div className="max-w-5xl mx-auto">
          <div className="bg-black border-2 border-red-600/30 p-12 text-center text-white shadow-2xl shadow-red-600/10">
            ...
            <div className="bg-gray-900 border border-gray-800 p-6 mb-8 max-w-2xl mx-auto">
            ...
            <button className="bg-red-600 text-white px-12 py-5 hover:bg-red-700 transition-colors inline-flex items-center gap-3 font-bold uppercase tracking-wide text-sm border border-red-500 shadow-lg shadow-red-600/30 mb-6">
      ...
      {/* Footer */}
      <footer className="bg-black border-t border-gray-800 text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <button className="bg-red-600 text-white px-8 py-3 hover:bg-red-700 transition-colors mb-6 font-bold uppercase tracking-wide text-sm border border-red-500">
              Request Access
            </button>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 border-t border-gray-800 pt-12">
            <div>
              ...
              <ul className="space-y-2 text-xs text-gray-500">
                <li><a href="#features" className="hover:text-red-500 transition-colors uppercase tracking-wider">Protocol</a></li>
                <li><a href="#pricing" className="hover:text-red-500 transition-colors uppercase tracking-wider">Access</a></li>
                <li><a href="#testimonials" className="hover:text-red-500 transition-colors uppercase tracking-wider">Results</a></li>
              </ul>
            </div>
            <div>
